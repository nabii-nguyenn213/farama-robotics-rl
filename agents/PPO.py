...
from components.networks import ActorNetwork, MLP
...
class ValueCriticNetwork(nn.Module):
    ...
    def __init__(self, obs_dim, hidden_size=[256, 256], hidden_act="ReLU", output_act="Linear"):
        super().__init__()
        self.value_net = MLP([obs_dim, *hidden_size, 1], hidden_act, output_act)
...
class PPO_Agent:
    def __init__(self, config):
        ...
        self.critic = ValueCriticNetwork(obs_dim, hidden_size_critic).to(self.device)
